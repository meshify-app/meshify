...
<head>
    <title>Code coverage report for src/wrappers/rateLimit.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/wrappers</a> rateLimit.js</h1>
        <div class='clearfix'>
...
<a name='L29'></a><a href='#L29'>29</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
export default function(client, { jwksRequestsPerMinute = <span class="branch-0 cbranch-no" title="branch not covered" >10 } = <span class="branch-1 cbranch-no" title="branch not covered" >o</span>ptions) {</span>
