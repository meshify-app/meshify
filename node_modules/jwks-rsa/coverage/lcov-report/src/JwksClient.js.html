...
<head>
    <title>Code coverage report for src/JwksClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> JwksClient.js</h1>
        <div class='clearfix'>
...
<a name='L124'></a><a href='#L124'>124</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
  ...
  getKeys(cb) {
    ...
    request({
      ...
      if (err || res.statusCode &lt; 200 || res.statusCode &gt;= 300) {
        ...
        if (res) {
          return cb(new JwksError(<span class="branch-4 cbranch-no" title="branch not covered" >res.body &amp;&amp; (res.body.message || res.body) || <span class="branch-3 cbranch-no" title="branch not covered" >res.statusMessage || `Http Error ${r</span>es.statusCode}`));</span>
        }
        return cb(err);
      }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!keys || !keys.length) {
<span class="cstat-no" title="statement not covered" >        return c</span>b(new JwksError('The JWKS endpoint did not contain any keys'));
      }
&nbsp;
      const signingKeys = keys
          .filter((key) =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(!key.kid){
