...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { JwksClient } from './JwksClient';
&nbsp;
...
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >(o</span>ptions) =&gt; {
<span class="cstat-no" title="statement not covered" >  return n</span>ew JwksClient(options);
};
&nbsp;
